...
/**
 * HOST-side only (Фаза 5): maps the local loopback port a {@code HostConnection}'s TCP socket
 ...
 * — see the accounts+friends plan's Фаза 5 for the full mechanism and why two joiners sharing
